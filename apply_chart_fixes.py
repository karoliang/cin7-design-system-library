#!/usr/bin/env python3
"""
Apply all 6 chart variant TypeScript fixes in one atomic operation
"""
...
def read_fix_write():
    ...
    backup_path = f"{file_path}.backup-chart-typescript-{timestamp}"
    ...
    # All fixes will be stored here
    fixes_applied = []

    # Fix 1: AreaChart percentage variant
    print("\nApplying Fix 1: AreaChart percentage variant...")
    old_percentage = '''    typescript: `import { AreaChart } from '@cin7/highcharts-adapter/react';
...
export default MarketShareChart;`,
  ...
  splinearea: {'''
    ...
    new_percentage = '''    typescript: `import { AreaChart } from '@cin7/highcharts-adapter/react';
import React from 'react';
...
export default MarketShareChart;`,
  ...
  splinearea: {'''
    ...
    if old_percentage in content:
        content = content.replace(old_percentage, new_percentage, 1)
        fixes_applied.append("AreaChart percentage")
        print("  ✓ Applied")
    else:
        print("  ✗ NOT FOUND - content may have changed")
