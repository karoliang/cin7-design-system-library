#!/usr/bin/env python3
"""
Script to add comprehensive EmptyState code variants to codeVariants.ts
"""
...
# Find the emptystateExamples section
pattern = r'export const emptystateExamples: Record<string, CodeVariant> = \{[^}]+\n\};'

# Check if it exists
if not re.search(pattern, content, re.DOTALL):
    print("ERROR: Could not find emptystateExamples section")
    exit(1)

# The replacement content with all 12 variants
replacement = '''export const emptystateExamples: Record<string, CodeVariant> = {
  default: {
...
print("Successfully added EmptyState variants!")
print("Added 8 variants: default, withDescription, withSecondaryAction, noAction, fullWidth, searchResults, errorState, maintenanceMode")
