...
The `@cin7/ag-charts-adapter` package provides React, ExtJS, and Vanilla JavaScript chart components that integrate Highcharts with Cin7 design tokens. Create beautiful, interactive visualizations that match your design system.
...
- **[Package Documentation](https://cin7-dsl.netlify.app/packages/ag-charts-adapter)** - Complete API reference
