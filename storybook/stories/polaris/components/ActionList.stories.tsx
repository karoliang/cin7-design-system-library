...
import { SearchMinor, SettingsMinor, ExportMinor, DuplicateMinor, DeleteMinor, EditMinor, ViewMinor, CircleTickMinor, CircleDisabledMinor } from '@shopify/polaris-icons';
...
export const Default: Story = {
  args: {
    items: [
      { content: 'View product', icon: ViewMinor },
    ...
    return (
      <div style={{ height: '200px' }}>
        ...
        >
          <ActionList
            items={[
              { content: 'View details', icon: ViewMinor, onAction: () => console.log('View clicked') },
...
export const WithDisabledItems: Story = {
  args: {
    items: [
      { content: 'Available action', icon: ViewMinor },
