      ...
      <div style={{ width: '600px' }}>
        ...
        <div style={{ marginTop: '20px', padding: '20px', backgroundColor: '#f9fafb', borderRadius: '6px' }}>
          ...
          <div style={{ marginTop: '16px' }}>
            <p style={{ margin: '0 0 8px 0', fontSize: "var(--font-size-sm)", fontWeight: '600' }}>Quick Navigation:</p>
        ...
        <div style={{
          ...
          {detail && (
            <div style={{
              ...
              <div style={{ fontSize: "var(--font-size-xs)", fontWeight: '600' }}>✅ Ready to execute: {detail.replace(/-/g, ' ').toUpperCase()}</div>
            </div>
          )}
        </div>
      </div>
        ...
        <div style={{ marginTop: '20px', padding: '20px', backgroundColor: '#f8fafc', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: '20px' }}>
            <div style={{ backgroundColor: 'white', borderRadius: '4px', border: '1px solid #e2e8f0', padding: '12px' }}>
              <h4 style={{ margin: '0 0 12px 0', fontSize: "var(--font-size-sm)", fontWeight: '600' }}>Navigation Tree</h4>
