...
export const BasicUsage: Story = {
  render: () => (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <TextContainer>
        <h2 style={{ fontSize: "var(--font-size-2xl)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '16px' }}>
          Introduction to Our Platform
        </h2>
        <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#374151' }}>
  ...
  render: () => (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <TextContainer spacing>
        <h2 style={{ fontSize: 'var(--font-size-3xl)', fontWeight: 'var(--font-weight-semibold)', marginBottom: '16px' }}>
          The Future of E-Commerce
        </h2>

        <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#374151', marginBottom: '16px' }}>
        ...
        <h3 style={{ fontSize: "var(--font-size-xl)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '12px', marginTop: '24px' }}>
...
export const ProductDescription: Story = {
  render: () => (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <TextContainer>
        <h2 style={{ fontSize: "var(--font-size-xl)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '12px' }}>
          Premium Wireless Headphones
        </h2>

        <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#374151', marginBottom: '12px' }}>
        ...
        <h3 style={{ fontSize: 'var(--font-size-base)', fontWeight: 'var(--font-weight-semibold)', marginBottom: '8px' }}>
          Key Features
        </h3>

        <ul style={{ color: '#374151', lineHeight: 'var(--line-height-relaxed)', paddingLeft: '20px', marginBottom: '12px' }}>
  ...
  render: () => (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <TextContainer spacing>
        ...
        <h3 style={{ fontSize: "var(--font-size-lg)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '12px' }}>
        ...
        <div style={{
          ...
          <h4 style={{ fontSize: 'var(--font-size-base)', fontWeight: 'var(--font-weight-semibold)', marginBottom: '8px', color: '#1e40af' }}>
            💡 Pro Tip
          </h4>
          <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#1e40af', fontSize: "var(--font-size-sm)" }}>
...
export const BlogPost: Story = {
  render: () => (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <TextContainer spacing>
        <h2 style={{ fontSize: "var(--font-size-3xl)", fontWeight: 'var(--font-weight-bold)', marginBottom: '16px' }}>
          5 Strategies to Boost Your E-Commerce Sales This Holiday Season
        </h2>

        <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#6b7280', fontSize: 'var(--font-size-base)', marginBottom: '24px' }}>
          Published on November 15, 2024 • 5 min read
        </p>

        <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#374151', marginBottom: '20px' }}>
        ...
        <h3 style={{ fontSize: "var(--font-size-2xl)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '16px' }}>
        ...
        <blockquote style={{
          ...
          <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#4b5563', fontSize: "var(--font-size-lg)" }}>
        ...
        <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#374151', marginTop: '20px' }}>
...
export const ComparisonLayout: Story = {
  render: () => (
    <div style={{
      ...
      <div>
        <h3 style={{ fontSize: "var(--font-size-lg)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '16px', textAlign: 'center' }}>
          Without TextContainer
        </h3>
        <div style={{ padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px' }}>
          <h4 style={{ fontSize: 'var(--font-size-base)', fontWeight: 'var(--font-weight-semibold)', marginBottom: '8px' }}>
            Standard Layout
          </h4>
          <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#374151', fontSize: "var(--font-size-sm)" }}>
  ...
  render: () => (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <TextContainer spacing>
        ...
        <ul style={{ color: '#374151', lineHeight: 'var(--line-height-relaxed)', paddingLeft: '20px', marginBottom: '16px' }}>
        ...
        <div style={{
          ...
          <h4 style={{ fontSize: "var(--font-size-sm)", fontWeight: 'var(--font-weight-semibold)', marginBottom: '8px', color: '#92400e' }}>
            ⚠️ Important Note
          </h4>
          <p style={{ lineHeight: 'var(--line-height-relaxed)', color: '#92400e', fontSize: "var(--font-size-sm)" }}>
